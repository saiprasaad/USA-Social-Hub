...
import { Divvytrips } from '../../modals/divvytrips';
...
export class DivvyTripsChartComponent implements OnInit {
  ...
  private updateChartBars(data:any){
    ...
    .attr('class', 'bar')
    .attr('x', (d:any) => this.x(d.hour_timestamp) )
    .attr('y', (d:any) => this.y(d.total_trips) )
    .attr('width', this.x.bandwidth())
    .attr('height', (d:any) => this.height - this.y(d.total_trips) );
  }
